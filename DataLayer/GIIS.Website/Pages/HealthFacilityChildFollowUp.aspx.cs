...
public partial class Pages_HealthFacilityChildrenRegistrationsFollowUp : System.Web.UI.Page
{
    ...
    protected void createInputControls(){
        ...
        inputControl.Attributes.Add("title", "Follow Up Report Description");
        ...
        inputControl2.Attributes.Add("title", "Follow Up Report Description");
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        odsHealthFacilityFollowUp.SelectParameters.Clear();
        odsHealthFacilityFollowUp.SelectParameters.Add("hfid", selectedHealthFacilityID);
        odsHealthFacilityFollowUp.SelectParameters.Add("fromDate", strFromDate);
        odsHealthFacilityFollowUp.SelectParameters.Add("toDate", strToDate);
        odsHealthFacilityFollowUp.DataBind();
        gvHealthFacilityFollowUp.DataSourceID = "odsHealthFacilityFollowUp";
        gvHealthFacilityFollowUp.DataBind();

        createInputControls();
        
    }

    protected void gvHealthFacilityFollowUp_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
        gvHealthFacilityDefaulters.PageIndex = e.NewPageIndex;
    }

    protected void gvHealthFacilityFollowUp_DataBound(object sender, EventArgs e)
    {
    ...
    protected void gvHealthFacilityFollowUp_DataBound(object sender, GridViewRowEventArgs e)
    {
