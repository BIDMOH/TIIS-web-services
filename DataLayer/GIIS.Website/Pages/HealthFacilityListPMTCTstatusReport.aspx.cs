...
public partial class Pages_HealthFacilityListPMTCTstatus : System.Web.UI.Page
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        odsHealthFacilityListPMTCTstatus.SelectParameters.Clear();
        odsHealthFacilityListPMTCTstatus.SelectParameters.Add("hfid", selectedHealthFacilityID);
        odsHealthFacilityListPMTCTstatus.SelectParameters.Add("fromDate", strFromDate);
        odsHealthFacilityListPMTCTstatus.SelectParameters.Add("toDate", strToDate);
        odsHealthFacilityListPMTCTstatus.DataBind();
        gvHealthFacilityListPMTCTstatus.DataSourceID = "odsHealthFacilityListPMTCTstatus";
        gvHealthFacilityListPMTCTstatus.DataBind();

        createInputControls();
        
    }

    protected void gvHealthFacilityListPMTCTstatus_PageIndexChanging(object sender, GridViewPageEventArgs e)
    {
