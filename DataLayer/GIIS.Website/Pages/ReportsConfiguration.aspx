 ...
 ******************************************************************************
--%>
<%@ Page Title="Health Facility List" Language="C#" MasterPageFile="~/Pages/MasterPage.master" AutoEventWireup="true" CodeFile="ReportsConfiguration.aspx.cs" Inherits="Pages_HealthFacilityList" EnableEventValidation="false" %>
      ...
      <div class="row">
        <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 clearfix">
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <asp:Label ID="lblTitle" runat="server" Text="Reports Configuration Health Facility List" /></li>
            </ol>
        </div>
    </div>
   <div class="row">
    ...
    <div class="row">
        ...
        <asp:GridView ID="gvHealthFacility" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover table-responsive" AllowPaging="True" OnDataBound="gvHealthFacility_DataBound" OnPageIndexChanging="gvHealthFacility_PageIndexChanging">
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Name">
                    <ItemTemplate>
                        <asp:HyperLink ID="hlName" runat="server" NavigateUrl='<%# Eval("Id", "ReportsConfigurationDetails.aspx?id={0}") %>'
        ...
        <asp:ObjectDataSource ID="odsHealthFacility" runat="server" EnablePaging="true" SelectMethod="GetPagedNonDistrictCouncilHealthFacilityList" TypeName="GIIS.DataLayer.HealthFacility" SelectCountMethod="GetCountNonDistrictCouncilHealthFacilityList">
            <SelectParameters>
