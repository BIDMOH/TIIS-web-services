 ...
 ******************************************************************************
--%>
<%@ Page Title="View Coverage By Schedule Report" EnableEventValidation="false" Language="C#" AutoEventWireup="true" CodeFile="CoverageByPopulationReports.aspx.cs" Inherits="Pages_CoverageReport" MasterPageFile="~/Pages/MasterPage.master" %>
    ...
    <div class="row">
        ...
        <div class="row">
                    ...
                    <div class="col-md-9 col-xs-9 col-sm-9 col-lg-9 clearfix">
                         <h2><asp:Label ID="targetPopulation" Text="Target Population = 0" runat="server"/></h2>
                    </div>
