 ...
 ******************************************************************************
--%>
<%@ Page Title="View Session Report" EnableEventValidation="false" Language="C#" AutoEventWireup="true" CodeFile="HealthFacilityChildFollowUp.aspx.cs" Inherits="Pages_HealthFacilityChildFollowUp" MasterPageFile="~/Pages/MasterPage.master" %>
   ...
   <div class="row">
        <div class="col-md-12 col-xs-12 col-sm-12 col-lg-12 clearfix">
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <asp:Label ID="lblTitle" runat="server" Text="Missed Follow Up Report" /></li>
            </ol>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <h2><asp:Label ID="lblReportName" Text="Health Facilities Missed Follow Up " runat="server" /></h2>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            <em><asp:Label runat="server" ID="lblReportDescription" Text="This report shows the number and list of children who missed at least two immunization schedules. "  /></em>
        </div>
    </div>
    <br />
    ...
    <div class="row">
       ...
       <asp:GridView ID="gvHealthFacilityFollowUp" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered table-hover table-responsive" AllowPaging="True" OnRowDataBound="gvHealthFacilityFollowUp_DataBound" OnPageIndexChanging="gvHealthFacilityFollowUp_PageIndexChanging" PageSize="25">
        ...
        -->
        <asp:ObjectDataSource ID="odsHealthFacilityFollowUp" runat="server" SelectMethod="GetHealthFacilityFollowUpList" TypeName="GIIS.DataLayer.HealthFacilityDefaulters">
            <SelectParameters>
