...
public partial class Pages_CoverageByTargetPopulationReport : System.Web.UI.Page
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        odsAntigens.SelectParameters.Clear();
        odsAntigens.DataBind();
        gvCoverageReport.DataSourceID = "odsAntigens";
        gvCoverageReport.DataBind();
     ...
     protected void gvCoverageReport_PageIndexChanging(object sender, GridViewPageEventArgs e)
     {
         gvCoverageReport.PageIndex = e.NewPageIndex;
     }
    ...
    protected void gvCoverageReport_DataBound(object sender ,GridViewRowEventArgs e)
    {
        ...
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            GridView gvCoverageDetails = (GridView)e.Row.FindControl("gvCoverageReportDetails");
             ...
             objds.SelectParameters.Add(new Parameter("isSchedule", TypeCode.Boolean, "false"));
             objds.DataBind();
...
//         gvCoverageReportDetails.PageIndex = e.NewPageIndex;
    ...
    protected void gvCoverageReportDetails_DataBound(object sender ,GridViewRowEventArgs e)
    {
        ...
        {
            if (Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "CoveragePercentageValue")) >= 90 )
            {
                e.Row.Cells[8].ForeColor = System.Drawing.Color.Green;
            }else if (Convert.ToInt32(DataBinder.Eval(e.Row.DataItem, "CoveragePercentageValue")) >= 80 )
            {
        ...
        protected void btnPdf_Click(object sender, EventArgs e)
           {
               ...
               Response.AddHeader("content-disposition", "attachment;filename=Coverage Report by TargetPopulation.pdf");
               ...
               Paragraph paragraph = new Paragraph("Coverage Report by Target Population");
