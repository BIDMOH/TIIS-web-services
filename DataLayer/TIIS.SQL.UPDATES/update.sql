...
BEGIN
	...
	CREATE TABLE IF NOT EXISTS public."HEALTH_FACILITY_STOCK_DISTRIBUTIONS"
	    (
	      ...
	      CONSTRAINT "HEALTH_FACILITY_STOCK_DISTRIBUTIONS_pkey" PRIMARY KEY ("FROM_HEALTH_FACILITY_ID","TO_HEALTH_FACILITY_ID","DISTRIBUTION_DATE","VIMS_LOT_ID","PRODUCT_ID","QUANTITY","STATUS","DISTRIBUTION_TYPE")
